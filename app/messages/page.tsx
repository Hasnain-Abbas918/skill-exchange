...
function MessagesContent() {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg, #111827 0%, #1e3a5f 60%, #162b3a 100%)",
      }}
    >
      <Sidebar user={user} />
            ...
            {filteredUsers.length === 0 ? (
              ...
              filteredUsers.map((u) => (
                <button
                  ...
                  style={{
                    background:
                      selectedUser?.id === u.id ? "rgba(79,70,229,0.15)" : "transparent",
                    borderLeft:
                      selectedUser?.id === u.id ? "3px solid #4f46e5" : "3px solid transparent",
                  }}
                >
                  {/* Avatar */}
                  <div
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-white/30 text-xs truncate">{u.skillsOffered || "No skills listed"}</p>
                  </div>
        ...
        <div className="flex-1 flex flex-col">
          {!selectedUser ? (
            <div className="flex-1 flex flex-col items-center justify-center">
              ...
              <p className="text-white/30 text-sm">Choose a person to start chatting</p>
            </div>
          ) : (
            <>
              {/* Chat Header */}
                      ...
                      <div key={msg.id} className={`flex ${isMe ? "justify-end" : "justify-start"} gap-2`}>
                        ...
                        <div>
                          <div
                            ...
                            style={
                              isMe
                                ? { background: "linear-gradient(135deg, #4f46e5, #4338ca)", color: "white", borderBottomRightRadius: "4px" }
