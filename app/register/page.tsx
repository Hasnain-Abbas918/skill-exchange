    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 text-sm mt-1">Join SkillSwap — completely free</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {[
            { label: "Full Name", key: "name", type: "text", placeholder: "e.g. Sarah Ahmed", required: true },
            { label: "Email Address", key: "email", type: "email", placeholder: "sarah@example.com", required: true },
            { label: "Password", key: "password", type: "password", placeholder: "Min. 6 characters", required: true },
            { label: "What skills can you teach?", key: "skillsOffered", type: "text", placeholder: "e.g. Python, UI Design, Guitar", required: false },
            { label: "What do you want to learn?", key: "skillsWanted", type: "text", placeholder: "e.g. Photography, Spanish, React", required: false },
          ].map((field) => (
            <div key={field.key}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-xl text-white font-bold text-sm transition disabled:opacity-50 mt-2"
            style={{ background: "linear-gradient(135deg, #4f46e5, #06b6d4)" }}
          >
